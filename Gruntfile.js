...
module.exports = function (grunt) {
    ...
    grunt.registerTask('processJSON', 'A task that creates a hierarchial json format.', function() {
        ...
        csvData.forEach(function(row) {
            ...
            var value1 = parseFloat(row['2015-16']) || 0;
            var value2 = parseFloat(row['2016-17']) || 0;
            var value3 = parseFloat(row['2017-18']) || 0;
            var value4 = parseFloat(row['2018-19']) || 0;
            var value5 = parseFloat(row['2019-20']) || 0;
